#include "pch.h"
#include "HoloHUDMain.h"
#include "Common/DirectXHelper.h"

#include <windows.graphics.directx.direct3d11.interop.h>

using namespace HoloHUD;
...
HoloHUDMain::HoloHUDMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&HoloHUDMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&HoloHUDMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&HoloHUDMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void HoloHUDMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&HoloHUDMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&HoloHUDMain::OnCameraRemoved, this, _1, _2));
...
void HoloHUDMain::UnregisterHolographicEventHandlers()
{
...
HolographicFrame HoloHUDMain::Update()
{
...
bool HoloHUDMain::Render(HolographicFrame const& holographicFrame)
{
...
void HoloHUDMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void HoloHUDMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HoloHUDMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void HoloHUDMain::OnCameraAdded(
...
void HoloHUDMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void HoloHUDMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HoloHUDMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HoloHUDMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&HoloHUDMain::OnLocatabilityChanged, this, _1, _2));
